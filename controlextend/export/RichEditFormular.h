...
typedef struct dataFunc dataFunc;
class CONTROL_EXPORT CRichEditFormular : public CAutoRichEditCtrl
{
// Construction
public:
	CRichEditFormular();
	CString GetWordByOffset(int nOffset);
	static void SetDataFunc(const dataFunc *stritemsArr,int nItemCountText);
// Attributes
public:
	CXTipWnd m_TitleTip;
...
protected:
	...
	static const dataFunc *m_pstritemsArr;
	static int m_nItemCountText;
};
