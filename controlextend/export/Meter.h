...
class CONTROL_EXPORT  CMeter : public CStatic
{
...
protected:
	...
	COLORREF m_colorHighlight;		// 指针高部位	
	COLORREF m_colorShadow;			// 指针低部位
	COLORREF m_colorBKWindows;			//
	COLORREF m_colorScaleText;		// 刻度文本颜色
	COLORREF m_colorInnerPanel;		// 内圈颜色
