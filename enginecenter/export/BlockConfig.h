...
class TiXmlDocument;
class CViewData;
class ENGINECENTER_DLL_EXPORT CBlockConfigListener
{
public:
...
class ENGINECENTER_DLL_EXPORT CBlockInfo 
{
public:
...
// 板块表格数据字段
class ENGINECENTER_DLL_EXPORT CBlockDataPseudo
{
public:
	enum E_Header
	{
	...
	// 表头与对应值在这里获取
	bool32 GetColValue(E_Header eHeader, OUT void *pValue) const;
...
// 类似市场的板块数据
class ENGINECENTER_DLL_EXPORT CBlockLikeMarket
{
public:
...
// 板块集合
class ENGINECENTER_DLL_EXPORT CBlockCollection
{
public:
...
class ENGINECENTER_DLL_EXPORT CBlockConfig : public CObserverUserBlock
{
public:
