...
#define WM_SHOW_JPNEWS		WM_USER + 1001
#define WM_BROWER_PTR		WM_USER + 1002
#define WM_JPNEWS_TITLE		WM_USER + 1003
...
public:
	...
	void SetLoadData(std::string& data) { m_LoadDataStr = data ; }

	void SetFocusStatus(bool32 bFocusStatus) { m_bSetFocus = bFocusStatus ; }
private:
		bool32 m_bSetFocus;			// 是否抢光标
		std::string m_LoadDataStr;
protected:
	...
	CefString  m_sBackUrl;		// 页面出错的时候用于刷新
