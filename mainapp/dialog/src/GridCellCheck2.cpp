...
IMPLEMENT_DYNCREATE(CGridCellCheck2, CGridCell)

CGridCellCheck2::CGridCellCheck2() : CGridCell()
{
    m_bChecked = FALSE;
    //m_Rect.IsRectNull();
}

CSize CGridCellCheck2::GetCellExtent(CDC* pDC)
{
...
BOOL CGridCellCheck2::GetTextRect( LPRECT pRect)
{
...
BOOL CGridCellCheck2::SetCheck(BOOL bChecked /*=TRUE*/)
{
