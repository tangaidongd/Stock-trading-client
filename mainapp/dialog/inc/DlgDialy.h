#if !defined(AFX_DLGDIALY_H_)
#define AFX_DLGDIALY_H_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DlgDialy.h : header file
//
...
class CIoViewBase;
class CDlgDialy : public CDialogEx , public CViewNewsListner
{
public:
	enum E_ShowType
	{
	...
	virtual bool32 IsAttendNews() { return true; }

private:
	
	// Construction
protected:
	CDlgDialy(CWnd* pParent = NULL);   // standard constructor
	...
	static	auto_ptr<CDlgDialy> s_pDlg;
	
	// Dialog Data
	//{{AFX_DATA(CDlgDialy)
	enum { IDD = IDD_DIALOG_DIALY };
	CListBox	m_List;
