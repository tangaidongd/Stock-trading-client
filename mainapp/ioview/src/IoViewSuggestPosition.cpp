...
#define  FORMULAR_SUGGEST  L"建议仓位"
#define  DATA_LINE		L"仓位"
...
void CIoViewSuggestPosition::SetSize() 
{
	...
	m_RectTitle.InflateRect(-5, -5);	// 空隙
...
// 	CString StrStarategyWidth   = PAGE_STR_STRATEGY;
	...
	m_RectTitle.right = m_RectTitle.left + sizeWidth.cx* StrTitleWidth.GetLength() *1.2;	// 依据字体，固定宽绘制
