...
// 主题类, 用于通知者来继承
class ENGINECENTER_DLL_EXPORT CSubjectUserBlock
{
public:
...
// 观察者类
class ENGINECENTER_DLL_EXPORT CObserverUserBlock
{
public:
	CObserverUserBlock();
...
// 板块管理的基类:
class ENGINECENTER_DLL_EXPORT CBlockManager
{
public:
	CBlockManager();													// 默认构造
...
// 系统板块
class ENGINECENTER_DLL_EXPORT CSysBlockManager : public CBlockManager
{
private:
	CSysBlockManager(){}
...
// 用户板块,自选股
class ENGINECENTER_DLL_EXPORT CUserBlockManager : public CBlockManager, public CSubjectUserBlock
{
private:
	CUserBlockManager(){}
