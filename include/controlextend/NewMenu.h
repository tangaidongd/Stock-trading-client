...
Win32Type CONTROL_EXPORT IsShellType();

extern const Win32Type CONTROL_EXPORT g_Shell;
extern BOOL CONTROL_EXPORT bRemoteSession;
BOOL CONTROL_EXPORT IsMenuThemeActive();
...
BOOL CONTROL_EXPORT GetMenuInfo( HMENU hMenu, LPMENUINFO pInfo);
BOOL CONTROL_EXPORT SetMenuInfo( HMENU hMenu, LPCMENUINFO pInfo);

#define WS_EX_LAYOUTRTL         0x00400000L // Right to left mirroring

#define LAYOUT_RTL              0x00000001  // Right to left

DWORD CONTROL_EXPORT GetLayout(HDC hDC);
DWORD CONTROL_EXPORT SetLayout(HDC hDC, DWORD dwLayout);
...
CRect CONTROL_EXPORT GetScreenRectFromWnd(HWND hWnd);
CRect CONTROL_EXPORT GetScreenRectFromRect(LPCRECT pRect);
BOOL CONTROL_EXPORT TrackPopupMenuSpecial(CMenu *pMenu, UINT uFlags, CRect rcTBItem, CWnd* pWndCommand, BOOL bOnSide);

/////////////////////////////////////////////////////////////////////////////
// Forwarddeclaration and global function for menu drawing
void CONTROL_EXPORT DrawGradient(CDC* pDC,CRect& Rect,
                                  COLORREF StartColor,COLORREF EndColor, 
                                  BOOL bHorizontal,BOOL bUseSolid=FALSE);

void CONTROL_EXPORT MenuDrawText(HDC hDC ,LPCTSTR lpString,int nCount,LPRECT lpRect,UINT uFormat);


COLORREF CONTROL_EXPORT DarkenColorXP(COLORREF color);
COLORREF CONTROL_EXPORT DarkenColor( long lScale, COLORREF lColor);

COLORREF CONTROL_EXPORT MixedColor(COLORREF colorA,COLORREF colorB);
COLORREF CONTROL_EXPORT MidColor(COLORREF colorA,COLORREF colorB);

COLORREF CONTROL_EXPORT LightenColor( long lScale, COLORREF lColor);

COLORREF CONTROL_EXPORT BleachColor(int Add, COLORREF color);
COLORREF CONTROL_EXPORT GetAlphaBlendColor(COLORREF blendColor, COLORREF pixelColor,int weighting);

COLORREF CONTROL_EXPORT GetXpHighlightColor();
COLORREF CONTROL_EXPORT GrayColor(COLORREF crColor); 

/////////////////////////////////////////////////////////////////////////////
// Global helperfunctions
UINT CONTROL_EXPORT GetSafeTimerID(HWND hWnd, const UINT uiElapse);

BOOL CONTROL_EXPORT DrawMenubarItem(CWnd* pWnd,CMenu* pMenu, UINT nItemIndex,UINT nState);
void CONTROL_EXPORT UpdateMenuBarColor(HMENU hMenu=NULL);
CBrush CONTROL_EXPORT *GetMenuBarBrush();

int CONTROL_EXPORT NumScreenColors();
WORD CONTROL_EXPORT NumBitmapColors(LPBITMAPINFOHEADER lpBitmap);
HBITMAP CONTROL_EXPORT LoadColorBitmap(LPCTSTR lpszResourceName, HMODULE hInst, int* pNumcol=NULL);

COLORREF CONTROL_EXPORT MakeGrayAlphablend(CBitmap* pBitmap, int weighting, COLORREF blendcolor);
HBITMAP CONTROL_EXPORT CreateBitmapMask(HBITMAP hbmColour, COLORREF crTransparent);
...
class CONTROL_EXPORT CMenuTheme
{
public:
  CMenuTheme();
...
class CONTROL_EXPORT CMenuThemeXP :public CMenuTheme
{
public:
...
class CONTROL_EXPORT CMenuTheme2003 :public CMenuThemeXP
{
public:
...
class CONTROL_EXPORT CNewMenuIcons : public CObject
{
...
class CONTROL_EXPORT CNewMenuBitmaps : public CNewMenuIcons
{
...
class CONTROL_EXPORT CNewMenuItemData : public CObject
{
...
class CONTROL_EXPORT CNewMenuItemDataTitle : public CNewMenuItemData
{
...
class CONTROL_EXPORT CNewMenu : public CMenu
{
...
public:
  ...
  static void SetMenuBkColor(COLORREF clrMenuBk);
  static void SetMenuBitmapBkColor(COLORREF clrBitmapBk);
  static void SetMenuBorderColor(COLORREF clrBorder);
  static void SetMenuItemSelColor(COLORREF clrSel);
  static void SetMenuItemSelTextColor(COLORREF clrSelText);
  static void SetMenuItemNorTextColor(COLORREF clrNormalText);
  static void SetMenuItemDisableTextColor(COLORREF clrDisableText);
  ...
  // Destoying
  //lint -sem(CNewMenu::DestroyMenu,cleanup)  
...
public:
  ...
  static COLORREF m_clrMenuBk;
  static COLORREF m_clrMenuBitmapBk;
  static COLORREF m_clrMenuBorderBk;
  static COLORREF m_clrMenuItemSelBk;
  static COLORREF m_clrMenuItemSelText;
  static COLORREF m_clrMenuItemNorText;
  static COLORREF m_clrMenuItemDisableText;
protected: 
...
class CONTROL_EXPORT CNewMenuThreadHook
{
// Initialization
public:
  CNewMenuThreadHook();
...
class CONTROL_EXPORT CNewFrame : public baseClass
{
...
class CONTROL_EXPORT CNewMiniDockFrameWnd: public CNewFrame<CMiniDockFrameWnd> 
{
...
class CONTROL_EXPORT CNewDialog : public CNewFrame<CDialog>
{
...
class CONTROL_EXPORT CNewMiniFrameWnd : public CNewFrame<CMiniFrameWnd>
{
...
class CONTROL_EXPORT CNewMDIChildWnd : public CNewFrame<CMDIChildWnd>
{
...
class CONTROL_EXPORT CNewFrameWnd : public CNewFrame<CFrameWnd>
{
...
class CONTROL_EXPORT CNewMDIFrameWnd : public CNewFrame<CMDIFrameWnd>
{
...
class CONTROL_EXPORT CNewMultiDocTemplate: public CMultiDocTemplate
{
...
class CONTROL_EXPORT CNewMemDC: public CDC
{
  CRect m_rect;
...
class CONTROL_EXPORT CNewMenuHelper
{
private:
  DWORD m_dwOldFlags;
...
class CONTROL_EXPORT CNewDockBar : public CDockBar
{
